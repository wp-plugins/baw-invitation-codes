...
?>
	<p>
		...
		<span style="font-style: italic; position: relative; top: -15px;"><?php echo !empty( $baweic_fields['text_link'] ) ? wp_filter_post_kses( addslashes( $baweic_fields['text_link'] ) ) : ''; ?></span>
		<?php endif; ?>
	</p>
 <?php
}
